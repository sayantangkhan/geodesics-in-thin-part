...
Outline of section.
\begin{enumerate}[(1)]
\item Define the one-sided systole region.
\item Point out its drawbacks, and the lack of quasi-convexity.
...
\item Say something about why our methods won't work to show statistical convex co-compactness for the full Teichmüller space.
\end{enumerate}
