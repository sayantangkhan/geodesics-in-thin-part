...
\begin{theorem}[Distance formula]
  ...
  \begin{align*}
    d(x, y) \approx \sum_{Y} \left[ d_Y(x, y) \right]_k &+ \sum_{\alpha \not \in \Gamma} \left[ \log(d_{\alpha}(x, y)) \right]_k + \max_{\alpha \in \Gamma} d_{\mathbb{H}_{\alpha}}(x, y) \\
    &+ \max_{\alpha \in \Gamma_1} \log \frac{1}{\ell_x(\alpha)} + \max_{\alpha \in \Gamma_2} \log \frac{1}{\ell_y(\alpha)}
  \end{align*}
\end{theorem}
