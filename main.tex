...
\begin{document}
\begin{abstract}
  We consider a finite volume deformation retract $\systole(\no_g)/\mcg(\no_g)$ of the moduli space of non-orientable surface $\mo(\no_g)$, and show that it behaves like the convex core of $\mo(\no_g)$.
...
\item[-] $\pitchfork$: $U \pitchfork_W V$ denotes that $U$ and $V$ are transverse when restricted to any subsurface of $W$ which intersects both $U$ and $V$ non-trivially.
