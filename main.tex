...
\begin{example}
  ...
  Let $x$ be a point in $\teich(\os)$, and $y = \delta \gamma \delta^{-1} x$.
  Let $\Omega(x, y) = \left\{ \os, V, \gamma V \right\}$.
  ...
  Observe that the geodesic $[x,y]$ almost immediately moves into a production region associated to $V$ at the beginning, leaves that product region at some point $w$ along the geodesic, and then enters the product region associated to $\gamma V$ at some point $z$, and then stays in that product region almost all the way up to the end.
...
\begin{proposition}
  ...
  \begin{align*}
    \mathfrak{L}_{\Omega}(x,y) \leq \left( \hNP(\os) + \frac{K}{\mathbf{C}} \right) d_{\teich(\os)}(x, y)
  \end{align*}
...
\item {\color{red} DONE:} Then define complexity length.
