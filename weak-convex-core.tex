...
\begin{proof}
  ...
  \item[Case (i)] In this case, we pick $p$ to lie along the axis of the pseudo-Anosov $\gamma$.
    ...
    This composed projection still has bounded diameter because the first projection does, and the second projection increases distances by a multiplicative factor.
