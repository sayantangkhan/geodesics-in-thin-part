...
\textcite{gekhtman2023dynamics}, and \textcite{CGTY} (which is upcoming work) prove the following theorems about statistically convex cocompact actions of subgroups of mapping class groups on Teichmüller space.
...
\begin{theorem}[Theorem 4.9 of \cite{gekhtman2023dynamics}]
  ...
  If $\Gamma$ is a subgroup of the mapping class group such that the associated Bowen-Margulis is finite, then the geodesic flow is mixing with respect to $\mu_{\mathrm{BMS}}$.
\end{theorem}
