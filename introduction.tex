...
The random walk argument gives us that the number of geodesics entering the thin part is at most $\exp(\hNP - 1)$, where $\hNP$ is the discrete analog of the volume growth entropy of $\systole(\no_g)$, whereas the number of geodesics is $\exp(\hLP)$.
...
\todo[inline]{Figure out the name of the grant I should thank.}
